...
const INITIAL_MEMORIES: PhotoMemory[] = [
  {
    ...
    caption: 'Best Birthday Moments! ðŸŽ‰',
    date: 'Special Memory',
    sticker: 'ðŸ¥³'
  },
  {
    ...
    caption: 'Celebration & Laughter ðŸŽ‚',
    date: 'Good Times',
    sticker: 'ðŸŒŸ'
  },
  {
    ...
    caption: 'Sweet Birthday Treats ðŸ°',
    date: 'Memories',
    sticker: 'ðŸ’–'
  }
];
    ...
    if (file) {
      compressImage(file, (dataUrl) => {
        const newMem: PhotoMemory = {
          id: `m-${Date.now()}`,
          url: dataUrl,
          caption: newCaption.trim() || 'Unforgettable Birthday Memory â¤ï¸',
          date: 'Today',
          sticker: 'ðŸŽ‰'
        };
