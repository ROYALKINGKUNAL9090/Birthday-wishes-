...
const DEFAULT_PROFILE: BirthdayProfile = {
  ...
  age: 25,
  photoUrl: '',
  headline: 'Happy Birthday, [Name]! ðŸŽ‰',
  message: 'Wishing you an extraordinary birthday filled with boundless joy, warm laughter, unforgettable surprises, and delicious cake! May all your dreams sparkle brighter than ever this year. Thank you for being such an amazing soul in everyone\'s lives! â¤ï¸âœ¨',
